...
pub fn get_handler_full(name: &str) -> Option<HandlerFullFn> {
    match name {
        ...
        "stdbat" => Some(|ac, rc| make_std_battle_handler(ac, rc)),
        "onstage" => Some(|ac, rc| make_always_on_stage_battle_handler(ac, rc)),
        "angbat" => Some(|ac, rc| make_always_on_stage_battle_handler(ac, rc)),
        "afgbat" => Some(|ac, rc| make_always_off_stage_battle_handler(ac, rc)),
